module VestalVersions
  ...
  module VersionTagging
    ...
    module InstanceMethods
      ...
      # the current version numb of the parent object.
      #
      ...
      #
      # Version records corresponding to version numb 1 are not typically created, but one will
      # be built to house the given tag if the parent object's current version numb is 1.
      def tag_version(tag)
        v = versions.at(version) || versions.build(:numb => 1)
        v.tag!(tag)
      end
    end
